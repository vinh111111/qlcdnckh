        ...
        <li class="custom-nav-item custom-avt-wrapper">
            <div class="custom-avt custom-dropdown">
                @if(Auth::check())
                    ...
                    @else
                        <img src="{{asset('/theme/'.$tk->image)}}" alt="User image" class="img-fluid rounded-circle mr-3 custom-dropdown-toggle" data-toggle="user-menu">
                    @endif
                @endif
            </div>
        </li>
...
<div class="custom-sidebar">
    <ul class="custom-sidebar-nav">
        ...
        <li class="custom-sidebar-nav-item">
            <a href="{{route('admin.getCategoryList')}}" class="custom-sidebar-nav-link">
                <div>
        ...
        <li class="custom-sidebar-nav-item">
            <a href="{{route('admin.getMyprofileAdmin')}}" class="custom-sidebar-nav-link active">
                <div>
