@extends('admin.profile.layout.master')
@section('css')
                ...
                <div class="tab-content">
                    <div class="tab-pane fade active show" id="personal-information" role="tabpanel">
                        <div class="iq-card">
                            ...
                            <form action="{{route('admin.postEditprofileAdmin',$user->id)}}" method="post" enctype="multipart/form-data">
                                @if(session('success1'))
                    ...
                    <div class="tab-pane fade" id="chang-pwd" role="tabpanel">
                        <div class="iq-card">
                            ...
                            <div class="iq-card-body">
                            <form action="{{route('admin.changepasswordAdmin',$user->id)}}" method="post">
                                @if(session('success2'))
                                    <div class="alert alert-success">
                                        {{ session('success2') }}
                                    </div>
