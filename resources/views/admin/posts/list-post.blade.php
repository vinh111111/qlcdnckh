                ...
                <div class="col-12 col-m-12 col-sm-12">
                    <div class="custom-card">
                        <div class="custom-card-header">
                            ...
                            <a href="{{route('admin.getAdminPostAdd')}}"><i class="fa fa-plus"></i></a>
                        </div>
                                ...
                                <tbody>
                                    @foreach($ds as $project)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.getAdminPostEdit', $project->id) }}" style="color:black"><i class="fas fa-pen"></i></a>
                                            </td>
                                            <td>
                                                <form action="{{route('admin.deletetAdminPost',$project->id)}}" method="post">
                                                    @csrf
                                                    @method('delete')
